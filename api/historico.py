...
while True:
	...
	if len(linhas_data) > 20:
		...
		#os.system("echo '' > ../historicos/hist_lat.txt ")
		#os.system("echo '' > ../historicos/hist_long.txt ")
		#os.system("echo '' > ../historicos/dataehora.txt ")
		print("OKKK")


	else:
		print("NÃO PRECISA DE LIMPEZA")
